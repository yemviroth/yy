    ...
    <div class="card">
        ...
        <form action="{{route('productdetail.store')}}" method="POST" enctype="multipart/form-data" class="">
                ...
                <div class="form-group row">
                        ...
                        <div class="col-md-2">
                            <div id="" class="input-group dd colorpicker-component">
                                <input autocomplete="off" name="proColor1" placeholder="Color 1" type="text" class="form-control color1" />
                        ...
                        <div class="col-md-2">
                            <div id="" class="input-group color2 colorpicker-component">
                                <input autocomplete="off" name="proColor2"  placeholder="Color 2" type="text"  class="form-control vaLcolor2" />
                            </div>
                        ...
                        <div class="col-md-2">
                            <div id="" class="input-group color3 colorpicker-component">
                                <input autocomplete="off" name="proColor3"  placeholder="Color 3" type="text"  class="form-control vaLcolor3" />
                            </div>
                        ...
                        <div class="col-md-2">
                            <div id="" class="input-group color4 colorpicker-component">
                                <input autocomplete="off" name="proColor4"  placeholder="Color 4" type="text" class="form-control vaLcolor4" />
                            </div>
                        ...
                        <div class="col-md-2">
                            <div id="" class="input-group color5 colorpicker-component">
                                <input autocomplete="off" name="proColor5"  placeholder="Color 5" type="text" class="form-control vaLcolor5" />
                            </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-4">
                        <input type="number" id="proPrice"  class="form-control" name="proPrice" required>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <textarea class="form-control" name="proTextIntro" id="txt-sm" rows="4"></textarea>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <textarea class="form-control sm text-kh" name="proHowTo" id="txt-sm" rows="8"></textarea>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <textarea class="form-control sm text-kh" name="proDescription" id="" rows="9"></textarea>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        ...
                        <textarea class="form-control sm text-kh" name="proDetail" id="txt-lg" rows="10"></textarea>
                ...
                <nav class="navbar fixed-bottom navbar-light bg-danger justify-content-end">
                        ...
                        <div class="float-right">
                            ...
                            <button class="btn btn-primary text-md-left" type="submit">Submit</button>
                        </div>
