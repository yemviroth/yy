    ...
    <div id="carouselExampleCaptions" class="carousel slide carousel-fade" data-ride="carousel" data-interval="3000">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item active">
                <img src="{{asset('images/slide/slide1.jpg')}}" class="d-block img-fluid" style="" alt="...">
            ...
            <div class="carousel-item">
                <img src="{{asset('images/slide/slide2.jpg')}}" class="d-block img-fluid" style="" alt="...">
                <div class="carousel-caption d-none d-md-block">
            ...
            <div class="carousel-item">
                <img src="{{asset('images/slide/slide3.jpg')}}" class="d-block img-fluid" style="" alt="...">
                <div class="carousel-caption d-none d-md-block">
            ...
            <div class="carousel-item">
                <img src="{{asset('images/slide/slide4.jpg')}}" class="d-block img-fluid" style="" alt="...">
                <div class="carousel-caption d-none d-md-block">
        ...
        <a class="carousel-control-prev" href="#carouselExampleCaptions" role="button" data-slide="prev">
            <span class="fas fa-chevron-left fa-4x text-dark" aria-hidden="true"></span>
            <span class="sr-only">Previous</span>
        </a>
        <a class="carousel-control-next" href="#carouselExampleCaptions" role="button" data-slide="next">
            <span class="fas fa-chevron-right fa-4x text-dark" aria-hidden="true"></span>
...
<div class="d-none d-md-block">
    ...
    <div class="marquee" id="mycrawler2" style="width:100%;">
        ...
        <a href="{{route('productdetail.show',$pro->proId)}}"><img src="{{asset('images/product/'.$pro->proImage)}}"
                style="width:250px" class="" alt=""></a>
        @endforeach
    </div>
</div>
</div>
...
<section class="pt-4" style="background: #fff">
    <div class="wrapper mx-auto my-5 pt-5 d-none d-md-block">
        <div class="row">
            <div class="col-md-6 d-none d-md-block ">
                <a href="https://www.facebook.com/theyeoncambodia"  class="shadow" target="_blank">
                    <div class="block">
                        <img src="{{asset('images/bannerFB.jpg')}}" alt="Avatar" class="image-cover" style="width:100%">
                        <div class="middle-cover">
                            <div class="text-cover" style="font-size:3rem;">FACEBOOK</div>
                            <div class="text-center text-light">FOLLOW US</div>
                        </div>
                    </div>
            ...
            <div class="col-md-6 d-none d-md-block ">
                <a href="https://www.instagram.com/theyeon_cambodia" class="shadow"  target="_blank">
                    <div class="block">
                        <img src="{{asset('images/bannerIG.jpg')}}" alt="Avatar" class="image-cover" style="width:100%">
                        <div class="middle-cover">
                            <div class="text-cover" style="font-size:3rem;">INSTAGRAM</div>
                            <div class="text-center text-light">FOLLOW US</div>
                        </div>
                    </div>
                        ...
                        <div class="content">
                            ...
                            <a href="{{route('productdetail.show',$pro->proId)}}" target="">
                                ...
                                <div class="content-details fadeIn-top float-left d-none d-md-block">
                                    ...
                                    @endif
                                    <div class="pb-4"><i class="fas fa-plus-circle fa-2x text-light"
                                            style="opacity: 0.5;"></i></i></div>
                                    <h6>{!!$pro->proName!!}</h6>

                                    @if($pro->proColor1!="")<span class="badge pl-4 border"
                                        style="background-color:{!!$pro->proColor1!!};"> </span>@endif
                                    @if($pro->proColor2!="")<span class="badge pl-4 border"
                                        style="background-color:{!!$pro->proColor2!!};"> </span>@endif
                                    @if($pro->proColor3!="")<span class="badge pl-4 border"
                                        style="background-color:{!!$pro->proColor3!!};"> </span>@endif
                                    @if($pro->proColor4!="")<span class="badge pl-4 border"
                                        style="background-color:{!!$pro->proColor4!!};"> </span>@endif
                                    @if($pro->proColor5!="")<span class="badge pl-4 border"
                                        style="background-color:{!!$pro->proColor5!!};"> </span>@endif
