...
<section>
  ...
  <section class="pl-5 pr-5 pb-5 pt-1">
    <div class="container">
      ...
      <div class="row pb-5">
        ...
        <div class="col-sm col-xl-8"><img class="pb-2 w-100 img-thumbnail" src="images/restaurant2.jpg"></div>
      ...
      <div class="row pb-5">
        ...
        <div class="col-sm col-xl-8"><img class="pb-2 w-100 img-thumbnail" src="images/restaurant1.jpg"></div>
  ...
  stationary bikes or lift barbells, we are sure you won't be disappointed.</P>
   -->
        ...
        <div class="col-sm col-xl-8"><img class="pb-2 w-100 img-thumbnail" src="images/restaurant3.jpg"></div>
